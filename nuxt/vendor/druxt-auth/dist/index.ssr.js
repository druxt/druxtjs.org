...
const NuxtModule = function(moduleOptions = {}) {
  ...
  this.options.auth = {
    ...
    strategies: {
      ...
      "drupal-authorization_code": {
        scheme: path.resolve(__dirname, "../templates/drupal-scheme.js"),
      ...
      "drupal-password": {
        scheme: path.resolve(__dirname, "../templates/drupal-password-scheme.js"),
  ...
  this.nuxt.hook("components:dirs", (dirs) => {
    dirs.push({ path: path.resolve(__dirname, "components") });
  });
